...
[![Progress](https://img.shields.io/badge/progress-100%25-green)](https://github.com/balkeumlabs/tee-fl-0g/blob/main/PROGRESS.md)
...
**Quick links:** [Quick start](#quick-start) · [Usage](#usage) · [Architecture](#visual-overview) · [Deep-dive](#engineering-deep-dive) · [Mainnet Deployment](docs/MAINNET_DEPLOYMENT.md) · [Mainnet Pipeline Test](docs/MAINNET_PIPELINE_TEST_EXPLANATION.md) · [API Reference](docs/API_REFERENCE.md) · [Explanation](docs/EXPLANATION.md) · [Roadmap](docs/ROADMAP.md) · [Next Steps](docs/NEXT_STEPS.md)
